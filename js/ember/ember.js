...
Ember._StringBuilder = function() {
  this._segments = new Array(10000);
  this._segmentCount = 0;
  this.length = 0;
};
Ember._StringBuilder.prototype.push = function(segment) {
  this._segments[this._segmentCount] = segment;
  this._segmentCount += 1;
  this.length += segment.length;
};
Ember._StringBuilder.prototype.toString = function() {
...
Ember._RenderBuffer = function(tagName) {
  ...
  // this.buffer = "";
  this.buffer = new Ember._StringBuilder();
};
